...
| id | severity | rule |
| --- | --- | --- |
<!-- | R-TEST-1 | MUST | Mỗi acceptance criteria trong task phải có ít nhất 1 test case tương ứng. | -->
<!-- | R-TEST-2 | MUST | Logic mới phải kèm test (unit hoặc integration) và test xanh trước khi coi là done. | -->
<!-- | R-TEST-3 | SHOULD | Test phủ cả happy path, error path và biên (boundary). | -->
